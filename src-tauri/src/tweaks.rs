...
pub fn catalog() -> Vec<Tweak> {
    vec![
        ...
        Tweak {
            ...
            name: "Remove QoS Reserved Bandwidth",
            category: "Network",
            description: "Sets NonBestEffortLimit to 0, releasing the 20% bandwidth Windows reserves for QoS by default.",
            rationale: "Windows silently reserves 20% of your connection for background QoS traffic. On a 100 Mbit link that's 20 Mbit you never use in games.",
            impact: "Up to 20% more available bandwidth for game traffic.",
            risk: "Low",
            requires_admin: true,
            reversible: true,
            actions: vec![
